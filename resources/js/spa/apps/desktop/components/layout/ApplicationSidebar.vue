<template>
    <aside class="fixed left-0 top-0 bottom-0 sticky-bar-bottom-offset z-50 bg-bg-pr border-r border-bord-pr">
                ...
                <div class="flex flex-col h-full pt-6">
                    <div class="mb-4 mx-6">
                        <div class="flex items-center gap-2">
                            <div class="block">
                                <RouterLink v-bind:to="{ name: 'home_index' }" class="font-serif italic text-[28px] font-bold tracking-wide bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-transparent bg-clip-text">
                                    MannConnect
                                </RouterLink>
                            </div>
                        </div>
