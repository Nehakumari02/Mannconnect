<template>
    <span class="inline">
        <span ref="publicationTextHolder" v-bind:class="[!state.textExpanded ? 'line-clamp-[12]' : '']" class="leading-6 text-lab-pr2 text-[14px] font-normal markdown-text break-words inline" v-html="markdownRenderer()"></span>
        <span v-if="state.textOverflow" class="inline opacity-90">
