        ...
        <x-accordion.form title="{{ __('business/ads.form.budget_targeting') }}">
            ...
            <div class="block">
                <div class="flex mb-6 gap-2">
                    <x-ui.buttons.pill size="sm" wire:attr.loading="disabled" type="submit" btnText="{{ route_is('business.ads.create') ? __('business/ads.form.create_button') : __('business/ads.form.save_button') }}"></x-ui.buttons.pill>
